...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Inserts generation | EDIT</title>
  </head>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-1">
          ...
          <input type="checkbox" id="ignore" <?php echo ((isset($rule->ignore) && $rule->ignore) ? 'checked' : ''); ?> name="" value="">
        </div>
        <div class="col-lg-1">
          <label for="">Populate</label> <br>

          <input type="checkbox" id="populate" <?php echo ((isset($rule->populate) && $rule->populate) ? 'checked' : ''); ?> name="" value="">
        </div>
        <div class="col-lg-5">
          <label for="">Duplicate:</label>
          <input type="checkbox"  <?php echo (isset($rule->duplicate) && $rule->duplicate ? 'checked' : ''); ?> id="duplicate_set" name="" value="">
          <input type="text" name="" <?php echo (isset($rule->duplicate) ? '' : 'disabled'); ?> value="<?php echo  isset($rule->duplicate) ? $rule->duplicate : '';?>" class="form-control" id="duplicate" value="">
      ...
      <table class="table" id="columns_table">
        <thead>
          ...
          <th><input class="unique unique_all" type="checkbox">Unique</th>
        ...
        <tbody>
          <?php foreach ($columns_list as $col): ?>
            ...
            <tr>
              ...
              <td>
                <input type="text" data-col-name="<?php echo $col['COLUMN_NAME']; ?>" placeholder="Label" class="col_label form-control" value="<?php echo (($rule_col) ? $rule_col->label : $col['COLUMN_NAME']); ?>" />
              </td>
              <td>
                <input type="text" placeholder="Suffix" value="<?php echo (($rule_col) ? $rule_col->suffix : ''); ?>" class="form-control col_suffix" />
              </td>
              <td>
                <input <?php echo (($rule_col && $rule_col->unique) ? 'checked' : ''); ?> type="checkbox" class="col_unique" name="" value="">
              </td>
              <td>
                <input <?php echo (($rule_col && $rule_col->required) ? 'checked' : ''); ?> type="checkbox" class="col_required" name="" value="">
              </td>
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="ext_wrapper">
                      ...
                      <h3>Extentions:</h3>
                      <textarea name="name" class="form-control f_ext" rows="3" cols="10"><?php echo $col->foreign['where']; ?></textarea>
      ...
      $('button#update_rule').click(function(e){
        ...
        $('.table tbody tr').each(function(index, obj){
          if($(this).find('td:nth-child(2) input.selected').is(':checked')){
            ...
            //   $(".f_wrapper").each(function(e){
            //     if($(this).find('.f_col').val() == column.col){
            //       column.foreign = {
